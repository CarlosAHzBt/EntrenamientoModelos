...
def train_model():
    ...
    model.train(data=r"C:\Users\carlo\PycharmProjects\pythonProject4\Baches Deteccion En Imagenes.v3i.yolov8\data.yaml",
                epochs=400, batch=16, imgsz=848, patience=50)
